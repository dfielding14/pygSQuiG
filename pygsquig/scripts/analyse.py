...
@click.option("--quantities", "-q", multiple=True, 
              default=["energy", "enstrophy"],
...
@click.option("--output", "-o", type=click.Path(),
              help="Output file for plot")
@click.option("--slope", "-s", type=float,
              help="Reference slope to plot")
...
@cli.command()
@click.argument("field_file", type=click.Path(exists=True))
@click.option("--field", "-f", default="theta",
              help="Field to plot")
@click.option("--output", "-o", type=click.Path(),
              help="Output file for plot")
@click.option("--cmap", "-c", default="RdBu_r",
              help="Colormap name")
...
@click.option("--start-time", "-s", type=float,
              help="Start time for averaging")
@click.option("--end-time", "-e", type=float,
              help="End time for averaging")
@click.option("--output", "-o", type=click.Path(),
              help="Output file for plot")
@click.option("--slope", type=float,
              help="Reference slope to plot")
def averaged_spectrum(field_dir, start_time, end_time, output, slope):
    ...
    k, E_k = compute_time_averaged_spectrum(
        Path(field_dir), start_time, end_time
    )
