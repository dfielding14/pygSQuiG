...
def plot_energy_balance(
    ...
    if injection_rate is not None:
        ax2.plot(time_data, injection_rate, "g-", linewidth=2, label="Injection")
    if dissipation_rate is not None:
        ax2.plot(time_data, dissipation_rate, "r-", linewidth=2, label="Dissipation")
    if injection_rate is not None and dissipation_rate is not None:
        net_rate = injection_rate - dissipation_rate
        ax2.plot(time_data, net_rate, "b--", linewidth=1.5, label="Net", alpha=0.7)
