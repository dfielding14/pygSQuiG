            ...
            if self.orientation == "zonal":
                ...
                if self.meander_amplitude > 0:
                    meander = (
                        ...
                        * jet_width
                        * jnp.sin(
                            2 * np.pi * self.meander_k * x / L - self.meander_phase_speed * t
                        )
                    )
                ...
                if self.meander_amplitude > 0:
                    meander = (
                        ...
                        * jet_width
                        * jnp.sin(
                            2 * np.pi * self.meander_k * y / L - self.meander_phase_speed * t
                        )
                    )
...
class TopographicForcing(PhysicalForcing):
    ...
    def __call__(
        ...
        if self.topography_type == "ridge":
            ...
            # Isolated seamounts
            forcing = self.amplitude * (jnp.sin(k * x) * jnp.sin(k * y))
