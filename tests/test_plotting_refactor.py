...
class TestPlottingRefactor:
    ...
    def test_plot_field_slice_basic(self, setup_data):
        ...
        try:
            ...
            result = plot_field_slice(theta, grid, "Test Field", 
    ...
    def test_plot_vorticity(self, setup_data):
        ...
        try:
            result = plot_vorticity(theta_hat, grid, alpha, 
                                  output_path=output_path)
    ...
    def test_plot_time_series(self):
        ...
        try:
            result = plot_time_series_multiplot(
                time, data_dict, output_path=output_path
            )
            assert result is None
            assert output_path.exists()
        finally:
