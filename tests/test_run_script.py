...
class TestRunScriptCLI:
    ...
    def test_run_minimal_simulation(self, minimal_config, temp_dir):
        ...
        assert any(output_dir.glob('checkpoints/step_*.h5')) or any(output_dir.glob('checkpoints/final_step_*.h5'))
